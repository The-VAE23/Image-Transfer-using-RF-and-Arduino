...
def logimg():
    ...
    imshape = ((240,426),(360,640),(480,854),(720,1280),(1080,1920),(480,640),(800,600),(720,960),(768,1024),(960,1280),(1050,1400),(1440,1080),(180,135))
    img = []
    while True:
        x=AR.inWaiting()
        if x>0:
    ...
    cv2.imwrite("D:/College/Data/LYpro/"+time_utc+'.png', img)
    # plt.imshow(img,'gray')   #Uncomment line for output in code
    print("Image saved")
